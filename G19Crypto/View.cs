...
namespace G19Crypto
{
    ...
    class View
    {
        ...
        private Bitmap LCD = new Bitmap(400, 200);
        ...
        public View(Model model, string appName)
        {
            ...
            LCD = getImage(@"\images\splash.jpg");
        ...
        public void drawScreen()
        {
            ...
            int imgWidth=40;
            int imgHeight=40;
            int marginTop = 15; int marginLeftRight=5;
            int rowOffsetY = marginTop;


            Bitmap bgImg = getImage(@"images\background.jpg");

            //Bitmap bgImg = getImage(@"images\bgImg.jpg", true, imgWidth, imgHeight);

            gfx.DrawImage(bgImg, marginLeftRight, rowOffsetY, bgImg.Width, bgImg.Height);
